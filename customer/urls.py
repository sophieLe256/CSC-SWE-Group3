...
from . import views
from .views import customer_login, initialize_customer_data, customer_signup, customer_options, customer_profile, customer_dashboard, customer_logout, place_order, submit_feedback, forgot_password
